...
module.exports = {
    ...
    entry: {
        ...
        registroEmpleados: './src/registroEmpleados.js'
    },
    output: {
        path: __dirname+'/dist/',
        publicPath: '/',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({template: './src/pug/registroEmpleados.pug', filename: 'registroEmpleados.html' ,minify: false, chunks: ['registroEmpleados']}),
